...
fname=fullfile(this_dir,'..','data','Raw_data','DataEstimation','data_QUANT1_CF.mat');
load(fname);
...
[irfsavem,irfsavec,irfsavecc,irfsave,rm,fvsave]=runfavarx_f_new(out,1,spec);

save('results','fvsave','irfsavem','irfsavec','irfsavecc','out','irfsave','spec')
