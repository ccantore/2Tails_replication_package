...
% Cross-refs to the online appendix (e.g. \ref{App:IV}, \ref{App:PriorPosterior}) require
% 2Tails_online_appendix.aux to exist: compile 2Tails_online_appendix.tex first, then this file (twice).
...
\includegraphics[width=0.9\textwidth]{figures_final/figure2_6.pdf}
...
\begin{figure}[ht!]
	...
	\caption{Impulse responses to a monetary policy shock.}
    \includegraphics
    [width=0.85\textwidth]{figures_final/figure3.pdf}    %[width=6.5in,height=2.5in,scale = 0.50, clip=true,trim = 0cm 10cm -0.5cm 11cm]{figures_final/figure3.pdf}
...
%[trim=left bottom right top, clip]
\includegraphics[width=0.7\textwidth]{figures_final/figure_ft_2.pdf}
...
%	\centering\includegraphics[width=\textwidth]{figures_final/test3}
	\includegraphics[width=0.9\textwidth]{figures_final/figure4_6.pdf}
	\label{FF:panel:IRF}
