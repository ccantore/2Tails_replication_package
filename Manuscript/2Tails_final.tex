...
\begin{figure}[ht!]
	...
	\centering\includegraphics[width=\textwidth]{figures_final/figure1.pdf}
...
\includegraphics[width=0.9\textwidth,trim = 2cm 5cm 2cm 5cm]{figures_final/char.pdf}
\label{CPS:char_us}
\end{figure}
...
\includegraphics[width=0.9\textwidth,trim = 2cm 5cm 2cm 5cm]{figures_final/industry_by_wage_quintile_cepr_av_app.pdf}
\label{CPS:char_us1}
...
\includegraphics[width=0.9\textwidth,trim = 2cm 8cm 2cm 8cm]{figures_final/ag_hours.pdf}
\label{Agg_h_us}
\end{figure}
%-----------
...
\begin{figure}[h!]
   ...
   \includegraphics[width=0.9\textwidth,trim = 2cm 4cm 2cm 4cm]%
...
\newpage
 ...
 \subsection{Hours by industry and by education attainments}\label{A:ind_edu}
  \begin{figure}[ht]
    \centering
    \caption{Proportion of individuals in different industries. }%
    \includegraphics[width=6in,height=7in,scale = 0.5, clip=true,trim = 2cm 7cm 2cm 7cm]{figures_final/industry_by_wage_quintile_cepr_av.pdf}
    \label{ind}%
...
\caption{IRF of hours at the 6 mth horizon to a monetary contraction. }%
    ...
    \includegraphics[width=6in,height=7in,scale = 0.5, clip=true,trim = 2cm 4cm 2cm 4cm]{figures_final/hours_ind.pdf}
...
\caption{Proportion of individuals with education less than high school (LTHS), high school (HS), some college (somecollege), college and advanced degrees (advanced).}%    
    \includegraphics[width=6in,height=7in,scale = 0.5, clip=true,trim = 2cm 7cm 2cm 7cm]{figures_final/college_by_wage2.pdf}
...
\caption{Employees by level of education in each industry for individuals earning below the 20th percentile of wage. }%    
    \includegraphics[width=6in,height=7in,scale = 0.5, clip=true,trim = 2cm 7cm 2cm 7cm]{figures_final/college_by_wage3.pdf}
\label{college3}%
...
%\includegraphics[trim=left bottom right top, clip]
    \includegraphics[width=6in,height=7in,scale = 0.5, clip=true,trim = 2cm 4cm 2cm 4cm]{figures_final/hours_educ1.pdf}
    \label{irf_educ1}%
   \end{figure}
...
%	\centering\includegraphics[width=\textwidth]{figures_final/test3}
	\centering\includegraphics[width=\textwidth]{figures_final/figure_wages.pdf}
	\label{FF:wages:IRF}
...
\section{Sample of Individuals Employed Continuously for Three Months}\label{A:SS}
 \begin{figure}[ht]
    ...
    \caption{IRF of hours for Individuals Employed Continuously for Three Months}%
     %\includegraphics[trim=left bottom right top, clip]
    \includegraphics[width=5in,height=5in,scale = 0.5, clip=true,trim = 1cm 0cm 1cm 0cm]{figures_final/figure_panel3M.pdf}
\label{fig:hours_3M}
   \end{figure}
